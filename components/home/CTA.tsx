...
export default function CTA() {
	return (
		<section className="container relative overflow-hidden border lg:flex lg:items-center lg:justify-between">
			<div className="space-y-8 flex flex-col items-center justify-center gap-1.5 py-12">
